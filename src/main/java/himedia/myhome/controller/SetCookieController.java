...
//	private static Logger logger = Logger.getLogger(SetCookieController.class);
	private static final long serialVersionUID = 5626566034931983708L;
...
//		testCookie
		...
		c.setMaxAge(24 * 60 * 60); // 쿠키를 유지할 시간 설정. ( 초 단위 ) => 24시간. -> 그 이후 소멸
//		domain, path, expire 등 쿠키 구성 요소 설정 가능
//		응답에 쿠키를 추가해줘야 브라우저에 저장
